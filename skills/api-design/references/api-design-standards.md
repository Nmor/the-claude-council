...
> Migrated `rules-library/common/api-design.md`: the endpoint checklist, the skill chain and its
> learning hooks. Pointed at by the "API design standards (endpoint checklist + skill chain)" row of
> `SKILL.md`.
>
