...
> Migrated `rules-library/common/contract-testing.md`: CDC (Pact) vs schema-based contracts, ten
> hard rules, per-stack examples, anti-patterns, tooling. Pointed at by the "Contract testing" row
> of `SKILL.md`.
>
