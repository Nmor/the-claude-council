...
> Migrated `rules-library/common/deprecation-lifecycle.md`: the four-stage lifecycle, ten hard
> rules, per-language annotation patterns, HTTP deprecation headers, anti-patterns. Pointed at by
> the "Deprecation lifecycle" row of `SKILL.md`.
>
