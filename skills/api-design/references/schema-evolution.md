...
> Migrated `rules-library/common/schema-evolution.md`: compatibility modes, the expand-contract
> pattern, ten hard rules, per-store specifics, anti-patterns, tooling. Pointed at by the "Schema
> evolution" row of `SKILL.md`.
>
