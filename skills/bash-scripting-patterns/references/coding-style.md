...
Covers the mandatory strict header, naming conventions, variable quoting, functions, argument
parsing, logging, cleanup traps, file length and idioms — the detail behind the SKILL.md row
**Coding style**.
