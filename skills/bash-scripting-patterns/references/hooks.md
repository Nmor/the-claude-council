...
Covers pre-commit and pre-push git hooks, the Shell CI workflow, EditorConfig for shfmt, and the
pre-push checklist for production scripts — the detail behind the SKILL.md row **Hooks + CI**.
