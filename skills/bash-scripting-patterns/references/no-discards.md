...
Covers the fifteen banned shell patterns, the required ShellCheck and shfmt configuration, and the
bash sweep verification block — the detail behind the SKILL.md row **No-discards (banned
patterns)**.
