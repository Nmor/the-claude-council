...
Covers when to use Bash and when not, the strict-mode template, long options, pipelines, retry with
backoff, subcommand dispatch, error propagation, config files and common pitfalls — the detail
behind
the SKILL.md row **Patterns**.
