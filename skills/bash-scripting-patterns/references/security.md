...
Covers command and argument injection, path traversal, secrets in argv, temp-file races, umask,
SUID,
curl/wget hardening, SSH quoting, secret-free logging and the required tooling — the detail behind
the
SKILL.md row **Security**.
