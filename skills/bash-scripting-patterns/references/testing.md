...
Covers bats-core idioms, what to test, mocking external commands, shunit2, kcov/bashcov coverage and
the seven hard rules for shell tests — the detail behind the SKILL.md row **Testing**.
