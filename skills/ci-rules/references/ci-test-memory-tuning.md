...
> Covers the CI test-suite memory budget: the OOM-preempt vs worker-thrash
> failure modes, runner RAM table, and per-framework (Jest / Vitest / pytest /
> Go) tuning. Pointed at by the SKILL.md routing row **CI test memory
> tuning**.
>
