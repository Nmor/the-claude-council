...
> Covers the Claude Code hook lifecycle, the mandatory global hooks,
> PreToolUse auto-accept policy, and TodoWrite practices. Pointed at by the
> SKILL.md routing row **Hook lifecycle, mandatory hooks, permissions,
> TodoWrite**.
>
