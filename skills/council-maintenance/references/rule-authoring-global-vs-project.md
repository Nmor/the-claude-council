# council-maintenance: rule-authoring-global-vs-project.md — full text

> Full text of the hard rules + anti-patterns of
> `~/.claude/rules/common/rule-authoring-global-vs-project.md`, whose always-on Floor copy carries
> only their summary. Pointed at by the `## Full rule text carried here` row in `../SKILL.md`.
>
