...
> Covers the migrated `rules-library/cpp/hooks.md` rule — pre-commit / pre-push gates, CMake
> hardening, the CI workflow, `.clang-format` and `.clang-tidy`. The "Migrated: hooks, CMake
> hardening, CI" row in ../SKILL.md points here.
>
