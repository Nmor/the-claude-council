...
> Covers the migrated `rules-library/cpp/no-discards.md` rule — the ten banned C/C++ patterns,
> required compiler flags, required static analysis and the verification block. The "Migrated:
> no-discards (banned patterns)" row in ../SKILL.md points here.
>
