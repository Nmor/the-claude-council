...
> Covers the migrated `rules-library/cpp/patterns.md` rule — RAII, smart pointers, value types,
> builder, PIMPL, type erasure, concurrency, reuse-first and modern C++ over C-isms. The "Migrated:
> C/C++ patterns" row in ../SKILL.md points here.
>
