# cpp-coding-standards: Philosophy & Interfaces (P., I.)

> Covers the Core Guidelines rule tables, examples and anti-patterns for Philosophy & Interfaces
> (P.*, I.*) and Functions (F.*). The "Philosophy, interfaces, functions" row in ../SKILL.md points
> here.
>
