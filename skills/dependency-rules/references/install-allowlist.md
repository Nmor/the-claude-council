...
> No silent global installs: banned install shapes, npm / VS Code / MCP / Homebrew publisher
> allowlists, what to do when the rule fires, editor and shell-level enforcement. Pointed at by the
> **Install allowlist** row of `SKILL.md`.
>
