...
> The SPDX license gate: org-level allowlist, default-safe and review-required licenses, fail-closed
> on UNKNOWN, Trove + GitHub License API cross-check, gate output and authoring. Pointed at by the
> **License allowlist** row of `SKILL.md`.
>
