...
> Deterministic builds: lockfiles, range syntax per ecosystem, image digest pins, SHA-pinned
> Actions, Renovate config, vendoring. Pointed at by the **Pinning** row of `SKILL.md`.
>
