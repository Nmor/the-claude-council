# django-testing: When to Activate

> Covers the 12-phase Django verification pipeline, its output template, the pre-deployment
> checklist, the CI workflow and the verification quick reference.
> Pointed at by the SKILL.md routing row "Verification pipeline (Phases 1-12)" and its sub-rows.
>
...
Remember: Automated verification catches common issues but doesn't replace manual code review and
