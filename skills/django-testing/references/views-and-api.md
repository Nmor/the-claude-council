# django-testing: View Testing

> Covers Django view tests and DRF serializer / ViewSet API tests.
> Pointed at by the SKILL.md routing rows "View testing" and "DRF API testing".
>
