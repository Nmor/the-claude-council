...
> Covers the 15 mandatory Dockerfile authoring rules, the mandatory header, the Hadolint rule
> mapping and the standards behind them — the "Coding style" row of the routing table in
...
- [`common/extreme-lint-policy.md`](../../../rules-library/common/extreme-lint-policy.md) —
  strict-by-default thresholds
- [`dockerfile/security.md`](../../../rules-library/dockerfile/security.md) — supply chain,
