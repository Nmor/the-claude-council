...
> Covers the 6-layer enforcement pipeline (pre-commit, pre-push, CI, deploy-time gate, runtime
> admission), the Hadolint configuration file and the developer tooling install — the "Hooks +
> enforcement pipeline" row of the routing table in `../SKILL.md` points here.
>
