...
> Covers the container threat model, the OWASP Docker Top 10 mapping, the 15 mandatory security
> rules, per-stack hardening and the Hadolint security rules — the "Security" row of the routing
> table in `../SKILL.md` points here.
>
...
caching. Chain related operations (rule 5 in
