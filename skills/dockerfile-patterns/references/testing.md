...
> Covers the 5 test layers (structure, smoke, Testcontainers integration, vulnerability +
> supply-chain, compliance), the CI gate composition, the 10 hard rules and the tool table — the
> "Testing" row of the routing table in `../SKILL.md` points here.
>
...
- [`dockerfile/coding-style.md`](../../../rules-library/dockerfile/coding-style.md) — style
  enforced by hadolint
- [`dockerfile/patterns.md`](../../../rules-library/dockerfile/patterns.md) — multi-stage, distroless
- [`dockerfile/security.md`](../../../rules-library/dockerfile/security.md) — security gates this
  validates
