...
> Covers the 16 hard rules of HTML/CSS style (semantic HTML, headings, labels, alt, lang, design
> tokens, layout, logical properties, focus, target size, reduced motion, contrast, naming, layer
> order, important, cleanroom CSS) plus the required stylelint + HTMLHint configs. Routed from the
> SKILL.md Reference map row **HTML / CSS coding style**.
>
