...
> Covers pre-commit and pre-push gates, the GitHub Actions frontend CI workflow, IDE integration,
> and the pre-deployment checklist. Routed from the SKILL.md Reference map row **HTML / CSS hooks +
> CI gates**.
>
