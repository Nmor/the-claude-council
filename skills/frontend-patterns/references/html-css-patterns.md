...
> Covers the 8 architectural patterns (token tiers, layout primitives, accessible components,
> container queries, compound components, forms, dialogs, skeletons), CSS architecture conventions,
> 7 anti-patterns, and reuse-first libraries. Routed from the SKILL.md Reference map row **HTML /
> CSS patterns**.
>
