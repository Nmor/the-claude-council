...
> Covers OWASP Top 10 alignment for markup and styling — XSS classes, strict CSP, SRI, security
> headers, auth forms, iframes, CSS-specific attacks, form hardening, and file upload security.
> Routed from the SKILL.md Reference map row **HTML / CSS security**.
>
