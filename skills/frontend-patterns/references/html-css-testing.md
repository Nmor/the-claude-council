...
> Covers the frontend testing pyramid, the 10 hard testing rules (Testing Library, keyboard path,
> states, axe-core, visual regression, E2E journeys, cross-browser, perf + bundle budgets, mutation
> testing), 5 anti-patterns, and the CI workflow shape. Routed from the SKILL.md Reference map row
> **HTML / CSS testing**.
>
