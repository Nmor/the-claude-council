...
Reference file for the **Docs sync with code** row of `../SKILL.md` — covers
every PR ships its docs with its code: the PR checklist, what "doc page exists"
means, the mechanical docs-sync gate, and what to do when a doc is already
stale. Source: `rules-library/common/docs-sync-with-code.md`.
