...
Reference file for the **Documentation requirements** row of `../SKILL.md` —
covers the Diataxis four-quadrant model, documentation surfaces, ten hard
rules, reference architectures (arc42 / C4 / ADR / runbook), per-language doc
tools, anti-patterns, and standards cited. Source:
