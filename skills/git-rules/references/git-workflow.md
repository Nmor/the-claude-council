...
Reference file for the **Git workflow** row of `../SKILL.md` — covers per-org
git identity, conventional commit format, the PR workflow, and the
feature-implementation loop. Source: `rules-library/common/git-workflow.md`.
