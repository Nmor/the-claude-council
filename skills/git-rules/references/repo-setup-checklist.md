...
Reference file for the **Repo setup checklist** row of `../SKILL.md` — covers
the 20-point first-touch repo audit — tracked-state hygiene, dependency
posture, infra posture, secrets posture, CI gates — plus the mechanical sweep
script. Source: `rules-library/common/repo-setup-checklist.md`.
