...
> Covers the migrated `rules-library/java/coding-style.md` rule body — naming + structure,
> immutability, null safety, modern collections / streams, file organisation, comments, required
> tooling. Pointed at by the `Coding style (full rule)` row of `../SKILL.md`.
>
