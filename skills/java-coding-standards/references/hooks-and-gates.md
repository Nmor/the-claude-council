...
> Covers the migrated `rules-library/java/hooks.md` rule body — pre-commit / pre-push gates, Maven
> lifecycle integration, Gradle equivalent, CI workflow shape. Pointed at by the `Hooks + build
> gates` row of `../SKILL.md`.
>
