...
> Covers the migrated `rules-library/java/patterns.md` rule body — layered Spring Boot architecture,
> records, sealed types, builders, constructor DI, exception handling, WebFlux, reuse-first. Pointed
> at by the `Architecture patterns` row of `../SKILL.md`.
>
