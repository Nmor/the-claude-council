...
> Covers the migrated `rules-library/java/security.md` rule body — OWASP Top 10 Java specifics
> (A01-A10), Spring Security baseline, secrets, required tooling. Pointed at by the `Security` row
> of `../SKILL.md`.
>
