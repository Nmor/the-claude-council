...
> Covers the migrated `rules-library/java/testing.md` rule body — the Java test pyramid and the 10
> hard rules (JUnit 5, AssertJ, parameterized tests, Mockito, Testcontainers, flakiness, coverage
> gates, mutation testing, naming, test resources). Pointed at by the `Testing` row of
> `../SKILL.md`.
>
