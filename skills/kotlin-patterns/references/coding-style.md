...
> Covers idiomatic Kotlin 2.0+ style: naming, null safety, immutability, sealed classes, scope
> functions, expression bodies, coroutine basics, file layout, KDoc, required tooling. Pointed at by
> the **Coding style** row in ../SKILL.md.
>
