...
> Covers the Kotlin enforcement layer: pre-commit / pre-push git hooks, the Gradle
> `build.gradle.kts` wiring for ktlint + detekt + dependency-check + jacoco, the GitHub Actions CI
> workflow, and the Android and Spring Boot additions. Pointed at by the **Hooks, Gradle + CI** row
> in ../SKILL.md.
>
