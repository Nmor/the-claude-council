...
> Covers Kotlin architecture patterns: hexagonal layering, result types, builder vs DSL, constructor
> DI, coroutines + Flow, MVI for Compose/Android, value classes, the common-pitfalls table, and the
> reuse-first library shortlist. Pointed at by the **Architecture patterns** row in ../SKILL.md.
>
