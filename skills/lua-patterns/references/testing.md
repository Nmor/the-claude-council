...
Covers busted idioms, stub / spy / mock, property-based testing, luacov coverage, multi-version
testing via hererocks, plenary.nvim for Neovim plugins, and the six hard rules. The detail
behind the SKILL.md row **Testing**.
