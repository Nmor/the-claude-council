...
> Covers the ADR template rule in full — what counts as an architectural decision, the required
> MADR-compatible structure, the ten hard rules, standards cited and learning hooks. Pointed at by
> the **ADR template** row of `../SKILL.md`.
>
