...
> Covers the runbook template rule in full — the required entry structure, the eight hard rules, the
> canonical incident classes, cross-references and learning hooks. Pointed at by the **Runbook
> template** row of `../SKILL.md`.
>
