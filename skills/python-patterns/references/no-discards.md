...
> Covers the Python no-discards extension: 17 banned patterns, required linters, pyproject gates,
> verification block. Pointed at by the **No-discards (Python)** row in
> [`../SKILL.md`](../SKILL.md).
>
