...
> Deploy failures become pre-deploy checks: the platform-limit table, authoring the check, what
> repeat firing means. Pointed at by the **Deploy failures become checks** row of `SKILL.md`.
>
