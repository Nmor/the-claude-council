...
> Feature flags: categories, owner + expiry + decision criteria, boundary evaluation, kill switches,
> cleanup, OpenFeature SDKs. Pointed at by the **Feature flags** row of `SKILL.md`.
>
