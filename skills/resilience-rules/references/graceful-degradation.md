...
> Graceful degradation: P0-P3 criticality tiers, cache-then-fallback and outbox patterns,
> degraded-mode UX, bulkheads, chaos testing. Pointed at by the **Graceful degradation** row of
> `SKILL.md`.
>
