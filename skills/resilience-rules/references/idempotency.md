...
> Idempotency: RFC 9110 method semantics, Stripe-style keys, webhook and queue dedupe, conditional
> writes, vendor primitives. Pointed at by the **Idempotency** row of `SKILL.md`.
>
