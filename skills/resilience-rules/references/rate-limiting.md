...
> Rate limiting: multi-layer defence, per-endpoint defaults, algorithm choice, RFC 6585 headers,
> auth-endpoint limits. Pointed at by the **Rate limiting** row of `SKILL.md`.
>
