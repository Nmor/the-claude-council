...
> Naming, Sandi Metz rules, frozen string literals, modern Ruby idioms, class structure, modules +
> mixins, and the strict `.rubocop.yml` baseline. Routed from the **Coding style** row of
> `../SKILL.md`.
>
