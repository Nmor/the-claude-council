...
> Pre-commit gates for staged Ruby files, Rails initializer hooks for security headers and parameter
> filtering, and the CI workflow. Routed from the **Hooks + CI** row of `../SKILL.md`.
>
