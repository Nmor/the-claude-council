...
> Service objects, form objects, query objects, value objects, concerns vs inheritance, ActiveRecord
> pitfalls, and the reuse-first sweep. Routed from the **Rails object patterns** row of
> `../SKILL.md`.
>
