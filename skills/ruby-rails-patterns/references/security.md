...
> OWASP Top 10 mapped to Rails specifics (A01-A10), CSRF + strong parameters, secrets handling, and
> the required security tooling. Routed from the **Security** row of `../SKILL.md`.
>
