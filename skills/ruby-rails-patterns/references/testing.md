...
> The Rails test pyramid, RSpec idioms, FactoryBot, WebMock + VCR, Capybara + Cuprite system tests,
> and the ten hard testing rules. Routed from the **Testing** row of `../SKILL.md`.
>
