...
> Covers: Rust coding style — naming, ownership/borrowing, error handling, modules, idioms, async,
> Cargo.toml + rustfmt + tooling setup. Pointed at by the SKILL.md routing row **Coding style**.
>
