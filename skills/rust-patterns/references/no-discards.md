...
> Covers: the 15 banned Rust discard/panic patterns, the required `Cargo.toml` lint table and the
> verification block. Pointed at by the SKILL.md routing row **No-discards extension**.
>
