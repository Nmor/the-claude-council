...
> Covers: Rust architecture patterns — workspace layout, newtype, enums, builder, trait ports, DI,
> async idioms, reuse-first and the four anti-patterns. Pointed at by the SKILL.md routing row
