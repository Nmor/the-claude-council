...
> Covers: Rust security — OWASP A02/A03/A06/A07/A10 specifics, `unsafe` discipline, secrets and the
> required security tooling. Pointed at by the SKILL.md routing row **Security**.
>
