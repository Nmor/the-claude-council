...
> Covers: Rust testing — test layout, proptest, async tests, HTTP mocking, insta, mockall, coverage
> gates and the five hard rules. Pointed at by the SKILL.md routing row **Testing**.
>
