...
> Covers schema/indexing/query patterns, partitioning and the four schema anti-patterns. Pointed at
> by the **Schema, index + query patterns** row in [../SKILL.md](../SKILL.md).
>
