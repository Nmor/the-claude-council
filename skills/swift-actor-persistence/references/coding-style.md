...
> Covers Swift coding style: naming, immutability, typed error handling, SwiftUI and concurrency
> conventions. Pointed at by the SKILL.md routing row **Swift coding style**.
>
