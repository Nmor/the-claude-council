...
Covers the YAML enforcement layer — pre-commit gates, pre-push gates, the CI workflow, IDE
integration, the pre-deployment checklist, and the verification block. Pointed at by the SKILL.md
routing row "Hooks + gates".
