...
Covers YAML architectural patterns — overlays, schema-first authoring, anchors, multi-document
files, frontmatter, `$ref` composition, Compose / Kustomize / Helm idioms, anti-patterns, and the
reuse-first tool list. Pointed at by the SKILL.md routing row "Architecture + composition".
